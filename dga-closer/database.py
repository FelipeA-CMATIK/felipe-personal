...
class Database:
    ...
    def massive_insert_statement(self, values):
        ...
        return "insert into {table} ({columns}) values {values};".format(table=self.table, columns=columns, values=placeholders)
